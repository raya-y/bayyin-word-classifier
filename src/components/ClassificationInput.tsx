  ...
  return <form onSubmit={handleSubmit} className="w-full max-w-2xl mx-auto">
      <div className="flex gap-3 items-center">
        <div className="relative flex-1">
          <Input type="text" value={word} onChange={e => setWord(e.target.value)} className="h-14 text-lg px-6 pr-12 bg-card border-2 border-border focus:border-primary transition-all duration-300 text-foreground placeholder:text-muted-foreground" disabled={isLoading} placeholder="" />
